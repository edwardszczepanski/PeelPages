...
<?php		
	...
	//if no address book is selected, redirect to index page
	if($addId==null)
	{
		header("Location: index.php");
		exit();
	}	
	//add new contact if it has enough information input
...
<?php
	//check delete flag to determine contact entry or not
            ...
            <form action="contacts.php" method="POST" id="sendForm" style="margin-top: 2%;">	
            	<table class="addContact">
					...
					<tr>		
						...
						<td>
							<input type="text" name="edit_address1" id="edit_ad1">
						</td>					
						<td>
							<p>Address2:	</p>
						</td>					
						<td>
							<input type="text" name="edit_address2" id="edit_ad2">
						</td>					
					</tr>                
					<tr>				
						<td>
					...
					<tr>               
						...
						<td>
							<input type="text" name="edit_zip" id="edit_zi">			
						</td>				
						<td>
